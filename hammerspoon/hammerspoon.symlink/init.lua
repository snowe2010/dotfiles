...
mainScreenSpaces = layout[spaces.mainScreenUUID()]
...
-- findAndMoveAppToSpace = function(appName, space)
-- --  print("Trying to move " .. app)
--   appWindows = hs.window.filter.new({appName}):getWindows()
--   for k,window in pairs(appWindows) do
--     print("window id here" .. window:id())
--     spaces.moveWindowToSpace(window:id(), mainScreenSpaces[space])
--   end
-- end

-- moveAppsToSpaces = function()
--   tempSpace = spaces.createSpace()
--   spaces.changeToSpace(tempSpace)
--   function launchApps()
--     hs.application.open("iterm")
--     hs.application.open("SourceTree")
--     hs.application.open("IntelliJ")
--     hs.application.open("Spotify")
--     hs.application.open("PostBox")
--     hs.application.open("Slack")
--     hs.application.open("Messages")
--     hs.application.open("fantastical")
--   end
-- --  launchApps()
  
--   function moveApps()
--     findAndMoveAppToSpace("iTerm2", 2)
--     findAndMoveAppToSpace("SourceTree", 2)
--     findAndMoveAppToSpace("IntelliJ IDEA-EAP", 3)
--     findAndMoveAppToSpace("Slack", 4)
--     findAndMoveAppToSpace("Postbox", 4)
--     findAndMoveAppToSpace("Fantastical", 4)
--     findAndMoveAppToSpace("Messages", 4)
--   end
  
--   moveApps()
  
--   spaces.changeToSpace(mainScreenSpaces[1])
--   spaces.removeSpace(tempSpace)
  
-- end

-- if (#mainScreenSpaces ~= 5) then
--   print('not enough screens, resetting everything')
-- else
--   print('enough screens?')
-- end

-- for k,v in pairs(mainScreenSpaces) do
--   print(k,v)
-- end
-- -- moveAppsToSpaces()
